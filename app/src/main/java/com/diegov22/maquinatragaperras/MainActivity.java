package com.diegov22.maquinatragaperras;
...
public class MainActivity extends AppCompatActivity {
    ...
    ImageView[] [] imagev=new ImageView[3][6];
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View botonl=findViewById(R.id.button1);
        onClick(botonl);
    ...
    class MiAsyncTask extends AsyncTask<Integer,Integer, String>
    {
        ...
        protected String doInBackground(Integer... parameter)
        {
            ...
            {
                int elementol=secuencia[columna][0];
                for (int i=0;i<8;i++)
                {
                    secuencia[columna][i]=secuencia[columna][i+1];
                }
                secuencia[columna][8]=elementol;
                try
                {
    ...
    public void onClick (View boton) {
        if (boton.getId()==R.id.button4 | boton.getId()==R.id.button5 | boton.getId()==R.id.button6)
        {
